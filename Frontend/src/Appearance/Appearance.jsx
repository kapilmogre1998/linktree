...
const defaultCards = [
    ...
    { color: 'orange', label: 'Mineral Orange', background: '#FEEEE2', stripe: '#FEEEE2', borderClr: '#CEE3EA' },
    { color: 'orange', label: 'Mineral Orange', background: '#FFF8E0', stripe: '#FFF8E0', borderClr: '#CEE3EA' },
];
